        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return fetch('https://api.ipify.org?format=json').then(function (x) {
              ...
              var ip = _ref2.ip;
              return Object({"NODE_ENV":"production","BASE_URL":"/cloufit/"}).ALLOWED_IP.includes(ip) ? next() : next({
                name: 'access.scanner'
              });
            }).catch(function () {
              return next({
